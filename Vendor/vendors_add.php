...
// Ambil galeri vendor
$galeri = $pdo->prepare("SELECT * FROM vendo r_gallery WHERE vendor_id = ?");
  ...
  <div class="container mx-auto px-6 flex flex-col md:flex-row justify-center items-start gap-16">
    ...
    <div class="w-full md:w-1/3">
      <div class="relative overflow-hidden rounded-lg shadow-lg">
        ...
        <button onclick="prevMini()" class="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow hover:bg-gray