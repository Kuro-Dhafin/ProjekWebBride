      ...
      <?php foreach ($vendors as $vendor): ?>
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group border border-pink-100">
          ...
          <div class="p-6 flex flex-col gap-2">
            ...
            <a href="vendor_detail.php?vid=<?= $vendor['vid'] ?>" class="mt-4 inline-block px-6 py-2 bg-pink-600 text-white rounded-full font-semibold shadow hover:bg-pink-700 transition text-center">
              Lihat Detail
            </a>
            <a href="vendor_edit.php?id=<?= $vendor['id'] ?>" class="mt-2 inline-block px-6 py-2 bg-yellow-500 text-white rounded-full font-semibold shadow hover:bg-yellow-600 transition text-center">
              Edit Vendor
            </a>
          </div>
        </div>
