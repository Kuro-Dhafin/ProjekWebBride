  ...
  <header class="py-4 bg-gradient-to-r from-softpeach to-blush shadow-md sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center px-4">
      ...
      <nav class="space-x-6">
        ...
        <a href="<?= $base ?>/Vendor/vendors.php" class="text-gray-600 hover:text-pink-600 font-semibold transition-colors duration-300">Vendors</a>
        <a href="<?= $base ?>/cart.php" class="text-gray-600 hover:text-pink-600 font-semibold transition-colors duration-300">Cart</a>
      </nav>
    </div>
  </header>
